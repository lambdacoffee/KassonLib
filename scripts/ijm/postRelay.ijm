...
function main() {
	...
	ijm_dir = kasson_lib_dir + "scripts" + File.separator + "ijm" + File.separator;
	boxification_macro_path = ijm_dir + "boxification.ijm";
	tiff_pdf_macro_path = ijm_dir + "tiff_to_pdf.ijm";
	boxified_intensities_macro_path = ijm_dir + "boxified_intensities.ijm";
