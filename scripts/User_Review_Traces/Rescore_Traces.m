function DataToSave = Rescore_Traces(DoNormalize)
...
i=1;
[~, filenameWithoutExt] = fileparts(src_filepath);
if contains(filenameWithoutExt, strcat('_mod-', method, '-rxd'))
    dst_filename = src_filepath;
else
    dst_filename = strcat(filenameWithoutExt, "_mod-", method, "-rxd.mat");
end
...
while i <= ntraces
    ...
    msg = strcat('Enter corresponding flag for function:\n', ...
        ...
        ' x -previous, s -skip, p -pause, r -resume \n');
