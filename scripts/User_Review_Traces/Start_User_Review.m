...
% this was altered -1 was put by me, don't know why this works
    for b = 1:NumReviewRounds-1
        ...
        while RerunThisRound =='y'
            ...
            Prompts = {'List IncorrectNumber.DesigCode'};
            DefaultInputs = {'No Correction Needed'};
            UserAnswer = inputdlg(Prompts,'Type q to quit', 1, DefaultInputs, 'on');
